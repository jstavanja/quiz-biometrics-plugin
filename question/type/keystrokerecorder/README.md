...
* Copy or rename the module directory to keystrokerecorder.
* Replace all occurances of keystrokerecorder in files with the new name for your question type.
* Rename files that have keystrokerecorder replacing keystrokerecorder with the new name for your question type.
* Replace '@copyright  2018 Jaka Stavanja (stavanja.xyz)' with something like @copyright  2013 Jamie Pratt (me@jamiep.org)
